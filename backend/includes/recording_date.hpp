...
//     public:
//         RecordingDate();
//         RecordingDate(const std::string& date_string);
//         virtual ~RecordingDate() = default;

//     public:
//         std::optional<std::string> format(const std::string & format_string, const std::string& locale) const;
//         std::optional<std::string> date(const std::string & format_string, const std::string & locale = "en") const{
//             return format(format_string, locale);
//         }
//     public:
...
//         int has_time() const {return _has_time;}
...
//         static constexpr int _day_in_months[] = {31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31};
...
//         bool parse_date_string(const std::string & date_string);
